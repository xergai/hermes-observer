...
The 0.29.0 observer keeps the `xerg.hermes.observer.v1` ledger and adds no heartbeat records to it.
...
or truncated byte metrics. Install Xerg and this observer at 0.29.0 for v0.20.x support and live
